...
(7)~a Linux-ABI shell with job control, functions, redirects, and an embedded Lua interpreter, and
(8)~TLA+ formal specifications proving safety properties of core protocols.
